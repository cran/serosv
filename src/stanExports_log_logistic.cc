...
#include "stanExports_log_logistic.h"

RCPP_MODULE(stan_fit4log_logistic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_log_logistic")
